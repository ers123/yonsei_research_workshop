...
| 기타 인명 | P08, P09 순차 | — |
| 국내 출연연 (15개) | 기관_[분야] 형식 | 기관_원자력, 기관_ICT, 기관_바이오 등 |
| 총괄 기관 | 총괄기관 | — |
...
## 체크 (데모 준비 완료 — 2026-04-22)

- [x] 5개 산출물 생성 (README, CLAUDE.md, codebook.md, deliverables 2개, viz 1개)
- [x] 원본 인명/기관명 잔여 0 hits (grep 검증)
- [x] HTML 브라우저 열어 작동 확인 (Plotly 2.27.0 로드 정상)
- [x] workshop day -1 까지 생성 완료
